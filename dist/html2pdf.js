...
(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.html2pdf = factory(global.jsPDF, global.html2canvas));
  ...
  Worker.prototype.toCanvas = function toCanvas() {
    ...
    return this.thenList(prereqs).then(function toCanvas_main() {
      ...
      return html2canvas__default['default'](this.prop.container, options);
  ...
  Worker.prototype.toPdf = function toPdf() {
    ...
    return this.thenList(prereqs).then(function toPdf_main() {
      ...
      this.prop.pdf = this.prop.pdf || new jsPDF__default['default'](opt.jsPDF);
  ...
  Worker.prototype.setPageSize = function setPageSize(pageSize) {
    return this.then(function setPageSize_main() {
      ...
      pageSize = pageSize || jsPDF__default['default'].getPageSize(this.opt.jsPDF); // Add 'inner' field if not present.
  ...
  Worker.prototype.thenCore = function thenCore(onFulfilled, onRejected, thenBase) {
    ...
    var selfPromise = isNative ? self : Worker.convert(_extends({}, self), Promise.prototype); // Return the promise, after casting it into a Worker and preserving props.
  ...
  jsPDF__default['default'].getPageSize = function (orientation, unit, format) {
  ...
  */
  ...
  Worker.prototype.toContainer = function toContainer() {
    return orig$1.toContainer.call(this).then(function toContainer_pagebreak() {
  ...
  html2pdf.Worker = Worker; // Expose the html2pdf function.
